...
export const IMAGE_MODELS = {
  ...
  stableDiffusionXL: {
    name: "Difusão Estável XL",
    label: "stableDiffusionXL",
  },
  removeBg: { name: "Remover Fundo", label: "removeBg" },
  upscale: { name: "Melhorar Resolução", label: "upscale" },
  illusionDiffusion: { name: "Difusão de Ilusão", label: "illusionDiffusion" },
};
