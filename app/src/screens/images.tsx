            ...
            <View style={styles.midChatInputWrapper}>
              <View style={styles.midChatInputContainer}>
                  ...
                  <>
                    ...
                    >
                      <View style={styles.midButtonStyle}>
                        ...
                        />
                        <Text style={styles.midButtonText}>Criar</Text>
                      </View>
                    </TouchableHighlight>
                  </>
                )}
                  ...
                  >
                    <View style={styles.midButtonStyle}>
                      ...
                      <Text style={styles.midButtonText}>
                        {image ? buttonLabel : "Escolher imagem"}
                      </Text>
                    </View>
                  </TouchableHighlight>
                )}
                {image && (
                  <View style={styles.midFileNameContainer}>
                    <Text style={styles.fileName}>
                      {image.name || "Imagem do rolo da câmera"}
                    </Text>
                    <TouchableHighlight
                ...
                <Text style={styles.chatDescription}>
                  Gere imagens e arte usando linguagem natural. Escolha entre
                  diversos modelos.
                </Text>
              </View>
            </View>
                ...
                <View>
                  ...
                  <View style={styles.modelLabelContainer}>
                    <Text style={styles.modelLabelText}>
                      Criado com o modelo Fal.ai {v.model}
                    </Text>
                  </View>
                </View>
              )}
            ...
            {!hideInput && (
              <View style={styles.chatInputContainer}>
                <TextInput
                  onChangeText={onChangeText}
                  style={styles.input}
                  placeholder="O que mais você quer criar?"
                  placeholderTextColor={theme.placeholderTextColor}
                  autoCorrect={true}
                  value={input}
                />
