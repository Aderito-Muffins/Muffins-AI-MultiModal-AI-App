...
const fonts = {
  ultraLightFont: "SFProText-Ultralight",
  thinFont: "SFProText-Thin",
  regularFont: "SFProText-Regular",
  lightFont: "SFProText-Light",
  mediumFont: "SFProText-Medium",
  semiBoldFont: "SFProText-Semibold",
  boldFont: "SFProText-Bold",
  blackFont: "SFProText-Black",
  ultraBlackFont: "SFProText-Ultrabold",
};
...
export { darkTheme, hackerNews, miami, vercel };
